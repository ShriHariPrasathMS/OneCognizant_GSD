...
public class LiveSupportGSDPage {
	...
	public String getWelcomeMessage() {
		...
		return (String) js.executeScript("return arguments[0].innerHTML",txt_welcome);
	}	
	public String getCurrentCountry() {
		JavascriptExecutor js = (JavascriptExecutor)driver;
		return (String) js.executeScript("return arguments[0].innerHTML",txt_defaultCountry);
	}
	public String getCurrentLanguage() {
		JavascriptExecutor js = (JavascriptExecutor)driver;
		return (String) js.executeScript("return arguments[0].innerHTML",txt_defaultLanguage);
	}
	...
	public void printAndWriteIInExcelOfContentOfPage(String sheetName) throws IOException{
		...
		for(WebElement txt_category : txt_categories) {
			...
			for(WebElement txt_title : txt_titles) {
				...
				ExcelUtility.write(sheetName, titleIndex, catgIndex, title);
