...
public class TestSuite_1 extends TestBase {
	...
	public void validateUser(String browser) throws IOException {
		...
		logger.info("-->Finshed TC-1-Validating User");
	}
	...
	public void checkDetails(String browser) throws IOException {
		...
		do {
			...
			gsdPage.printAndWriteIInExcelOfContentOfPage(("TS_05_C" + count + "_" + browser));
